...
import { ArrowLeft, Github, MessageCircleMore, Mail, ChevronDown, Terminal } from 'lucide-react';
import { RESUME_DATA } from '../../constantsAr.ts';
      ...
      <div className="absolute right-0 bottom-0 -z-10 h-[500px] w-[500px] rounded-full bg-purple-500/10 blur-[120px]"></div>
       ...
       <div className="container mx-auto px-4 sm:px-6 md:px-12 relative z-10">
        <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-20">
          ...
          <div className="flex-1 text-center lg:text-right pt-4 lg:pt-0">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 justify-center lg:justify-start mb-12">
              ...
              <a href="https://api.whatsapp.com/send?phone=96338791" className="px-8 py-4 rounded-lg border border-dark-border bg-dark-card hover:bg-dark-border text-slate-300 hover:text-white font-medium transition-all flex items-center gap-2 w-full sm:w-auto justify-center">
                تواصل معي
              </a>
            </div>
          ...
          {/* Left: Abstract Code Visualization (RTL) */}
          <div className="flex-1 w-full max-w-lg lg:max-w-xl relative hidden lg:block" dir="rtl">
            {/* Glow Effect */}
            <div className="absolute -inset-1 bg-gradient-to-r from-brand-500 to-purple-600 rounded-2xl blur opacity-20"></div>
            
            {/* Terminal Window */}
            <div className="relative bg-[#0a0f1e] border border-slate-800 rounded-xl shadow-2xl overflow-hidden text-right">
              ...
              <div className="p-6 font-mono text-sm leading-relaxed overflow-x-auto ">
                <div className="flex">
                  ...
                  <div>
                    ...
                    <div className="pl-4 text-slate-300">الاسم: <span className="text-green-400">'{RESUME_DATA.name}'</span>،</div>
                    <div className="pl-4 text-slate-300">الاسم الوظيفي: <span className="text-green-400">'{RESUME_DATA.title}'</span>،</div>
                    <div className="pl-4 text-slate-300">التخصص: <span className="text-yellow-300">['Fullstack', 'AI', 'Cloud']</span>،</div>
                    <div className="pl-4 text-slate-300">الحالة: <span className="text-green-400">'بناء المستقبل الرقمي'</span>،</div>
                    <div className="pl-4 text-slate-300">location: <span className="text-green-400">'مسقط، عمان'</span>،</div>
                    <div className="pl-4 text-slate-300">hireable: <span className="text-blue-400">صحيح.</span>،</div>
                    ...
                    <div className="pl-8 text-slate-300">
                      <span className="text-purple-400">return</span> <span className="text-green-400">"فلنتعاقد!"</span>؛
                    </div>
            ...
            <div className="absolute -left-6 top-1/2 transform -translate-y-1/2 flex flex-col gap-4">
              ...
              <SocialIcon href={`https://api.whatsapp.com/send?phone=96338791`} icon={<MessageCircleMore size={20} />} />
        ...
        <div className="absolute bottom-8 left-1/2 -translate-x-1/2 animate-bounce text-slate-600 hidden md:flex flex-col items-center gap-2">
          <span className="text-[10px] uppercase tracking-widest opacity-50">تمرير</span>
          <ChevronDown size={20} />
        </div>
      </div>
    </section>
